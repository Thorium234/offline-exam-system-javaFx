...
public class AppTheme {
    ...
    public static final String SIDEBAR_ICON_GRADES = "\uD83C\uDFAF";
    public static final String SIDEBAR_ICON_USERS = "\uD83D\uDC64";
    public static final String SIDEBAR_ICON_TEACHERS = "\uD83D\uDC68\u200D\uD83C\uDFEB";
    public static final String SIDEBAR_ICON_STREAMS = "\uD83D\uDCC1";
    public static final String SIDEBAR_ICON_SETTINGS = "\u2699\uFE0F";
    public static final String SIDEBAR_ICON_PUBLISH = "\uD83D\uDCE4";
    public static final String SIDEBAR_ICON_MARKS = "\u270F\uFE0F";
    public static final String SIDEBAR_ICON_ANALYSIS = "\uD83D\uDCCA";
    public static final String SIDEBAR_ICON_REPORTS = "\uD83D\uDCC4";
    public static final String SIDEBAR_ICON_BROWSE = "\uD83D\uDD0D";
    public static final String SIDEBAR_ICON_RECYCLE = "\u267B\uFE0F";
    public static final String SIDEBAR_ICON_DASHBOARD = "\uD83C\uDFE0";
    public static final String SIDEBAR_ICON_BULK = "\uD83D\uDCE6";
